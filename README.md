...
| 4 | 23 avr. | CyberOps module 14 - Les menaces et les attaques communes<br> Le segment, le paquet, la trame : révision sur le réseau. |  | |
| 5 | 25 avr.<br> samedi | Les outils de connexion : Ncat, socat, powershell | Exercice 2 - Analyseurs de protocoles ||
| 6 | 25 avr.<br> samedi | Les outils de découverte du réseau : ping, nping, nmap | **Exercice 3 - Introduction à ncat, socat et Powershell (ER)** ||
| 7 | 28 avr. | | Exercice 4 - Découvrir nping et nmap<br>**Exercice 5 - Découvrir scapy (ER)** |  **Évaluation - Menaces, attaques, vulnérabilités.**<br> **20 %** |
